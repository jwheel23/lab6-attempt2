...
@pytest.mark.parametrize(
    ...
    [
        (0, 5, 10, 15, 0),   # A ends before B starts
        (10, 15, 0, 5, 0),   # B ends before A starts

        (5, 10, 5, 10, 5),

        # Partial overlaps
        (0, 10, 5, 15, 5),   # A overlaps into B
        (5, 15, 0, 10, 5),   # B overlaps into A

        (5, 8, 0, 10, 3),    # A inside B
        (0, 10, 5, 8, 3),    # B inside A
